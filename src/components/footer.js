  ...
  return (
    <footer className={`${footer} ${isHidden ? 'footerHidden' : ''}`}>
      <div className={footerContent}>
        ...
        <p>Built with <a href="https://kiro.dev" target="_blank" rel="noopener noreferrer" style={{color: '#9fa8da', textDecoration: 'underline'}}>Kiro</a> & <a href="https://www.gatsbyjs.com" target="_blank" rel="noopener noreferrer" style={{color: '#9fa8da', textDecoration: 'underline'}}>Gatsby</a> • Deployed on <a href="https://www.netlify.com" target="_blank" rel="noopener noreferrer" style={{color: '#9fa8da', textDecoration: 'underline'}}>Netlify</a> • <a href="https://github.com/Aska-from-Antigua/personal-website" target="_blank" rel="noopener noreferrer" style={{color: '#9fa8da', textDecoration: 'underline'}}>View Source</a></p>
      </div>
    </footer>
  )
}
